...
class VendorOrderChatScreen extends StatefulWidget {
  ...
  @override
  State<VendorOrderChatScreen> createState() => _VendorOrderChatScreenState();
}

class _VendorOrderChatScreenState extends State<VendorOrderChatScreen> {
  final OrderChatService chatService = OrderChatService();
  final TextEditingController messageController = TextEditingController();
  final ScrollController scrollController = ScrollController();
  final ImagePicker picker = ImagePicker();

  final String vendorId = "vendor_1";
          ...
          Expanded(
            child: StreamBuilder<List<OrderChatMessageModel>>(
              ...
              builder: (context, snapshot) {
                ...
                if (messages.isEmpty) {
                  return const Center(
                    child: Text("No messages for this order yet 💬"),
                  );
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isMe = msg.senderType == "vendor";
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: "Reply about this order...",
                        filled: true,
